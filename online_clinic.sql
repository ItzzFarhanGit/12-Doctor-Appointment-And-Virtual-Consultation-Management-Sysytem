...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    -- NOTE: no "ON DELETE SET NULL" here on purpose. MySQL/MariaDB does not allow a
    -- STORED generated column (slot_lock above) to depend on a column that has an
    -- ON DELETE SET NULL/CASCADE foreign key action (error 1901 on import). Using the
    -- default RESTRICT also makes more sense here: an admin should not be able to
    -- silently delete a doctor/patient who still has appointment history - the
    -- admin panel now blocks that delete with a clear message instead.
...
VALUES (
    ...
    'Dr. Sarah Johnson',
    'sarah@gmail.com',
    '$2y$10$9ROs/3Po30vdkNQIYVzbVeTGg90ZHOYEp7a/udSlpGaWerAwjHG.O', -- password: Sarah123
    'Cardiology',
    1500,
    2500
);
