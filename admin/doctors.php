...
if (isset($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        ...
        // SAJEEFA FIX: foreign key (RESTRICT) blocks deleting a doctor who still has
        // appointment history, instead of silently failing while the page claimed success.
        $message = "❌ Cannot delete <b>$doctor_id</b> - this doctor still has appointment records. Delete those appointments first (Manage Appointments), then try again.";
    } else {
